...
import kotlinx.android.synthetic.main.activity_room.tabLayout
...
class RoomActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 목록 추가 버튼 클릭시
        roomAddlistBtn.setOnClickListener {
            val addIntent = Intent(this, AddListActivity::class.java)
            addIntent.putExtra("loc",2)
        ...
        // 2. 어댑터 생성 및 데이터 전달
        val viewPagerAdapter = CustomViewPagerAdapter(this, "room", tabData)
